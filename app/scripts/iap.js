        ...
        for (var i = 0; i < products.length; i++) {
            if (forGroup === 'all' || forGroup === products[i].group) {
                ...
                if (products[i].group === 'membership') {
                    ...
                    productActionButton = '<div class="iap-button" product-id="' + products[i].id + '" product-price="' + productPrice + '"><p class="iap-teaser">' + products[i].teaser + ' ' + products[i].price + '/年' + '</p><a href="buy://' + products[i].id + '"><button class="iap-move-left">现在订阅</button></a></div>';
